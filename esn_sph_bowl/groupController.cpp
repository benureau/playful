...
double lr;
 ...
 /* if(contextCtrl)
  {
    if(((s.val(0,0) < 0.1)) and ((s.val(0,0) > -0.1)) )
    {
     lr=1;
    }
...
//     if(((s.val(2,0) < 0.1)) and ((s.val(2,0) > -0.1)) )
	...
	/* I want swing behavior
	Axis5 = s.val(5,0);
        if(((s.val(3,0) < 0.3)) and ((s.val(3,0) > -0.3)) and ((s.val(4,0) < 0.3)) and((s.val(4,0) > -0.3)) and ((Axis5>0.4)or(Axis5<-0.4)) )*/
