...
namespace lpzrobots {
  ...
  public:
    ...
    bool   onlyMainParameters; ///< only powerfactor and stiffness/damping are configurable
  ...
  public:
    ...
    static VierBeinerConf getDefaultConfVelServos(){
      VierBeinerConf c = getDefaultConf();
      c.useVelocityServos = true;
      double stiffness = 0.01;
      c.hipDamping    = stiffness;
      c.kneeDamping   = stiffness;
      c.anklePower    = stiffness;
      return c;
    }
