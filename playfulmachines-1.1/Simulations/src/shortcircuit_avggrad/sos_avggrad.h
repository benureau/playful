 ...
 *                                                                         *
 ***************************************************************************/
#ifndef __SOSAVGGRAD_H
#define __SOSAVGGRAD_H
 ...
 */
class SosAvgGrad : public AbstractController {
...
public:
  ...
  virtual matrix::Matrix getS(); 
  virtual void setS(const matrix::Matrix& S);
...
protected:
  ...
  matrix::Matrix S; // Additional Model Matrix from sensor to sensor
  matrix::Matrix b; // Model Bias
  matrix::Matrix L; // Jacobi
  matrix::Matrix R; // AC+S
  ...
  paramval sense;          // # weighting of confinement term

  
  /// learn values model and controller (A,b,C,h)
  virtual void learn();

  /// returns the vector containing the diagonal elements
  matrix::Matrix diagonals(const matrix::Matrix& matrix);
